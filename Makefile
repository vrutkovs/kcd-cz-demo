...
install: create-s3-bucket create-google-sa create-hub-cluster update-infra-machine-hash bootstrap roll-out-infra-machines fill-up-vault install-hub wait-for-operators-to-be-stable update-scaled-hash ## Start install from scratch
