...
install: create-s3-bucket create-google-sa create-hub-cluster wait-for-operators-to-be-stable update-infra-machine-hash argocd-bootstrap roll-out-infra-machines fill-up-vault install-hub wait-for-operators-to-be-stable update-scaled-hash ## Start install from scratch
