...
install: create-s3-bucket create-google-sa create-hub-cluster argocd-bootstrap fill-up-vault install-hub wait-for-apps update-hashes ## Start install from scratch
