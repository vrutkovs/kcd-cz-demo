...
install: create-s3-bucket create-google-sa create-hub-cluster update-infra-machine-hash bootstrap roll-out-infra-machines update-scaled-hash  fill-up-vault install-hub wait-for-operators-to-be-stable ## Start install from scratch
